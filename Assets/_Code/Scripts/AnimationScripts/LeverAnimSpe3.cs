...
public class LeverAnimSpe3 : MonoBehaviour
{
    ...
    public void OnInteract()
    {
        ...
        bool platformState1 = _movingPieceAnimator1.GetBool("");
        bool platformState2 = _movingPieceAnimator2.GetBool("");

        _animator.SetTrigger(leverState ? "trOn" : "trOff");
        leverState = !leverState;

        _movingPieceAnimator1.SetTrigger(platformState1 ? "trDown" : "trUp");
        platformState1 = !platformState1;

        _movingPieceAnimator2.SetTrigger(platformState2 ? "trDown" : "trUp");
        platformState2 = !platformState2;
